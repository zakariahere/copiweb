...
class AgentDiscoveryServiceTest {
    ...
    private final AgentDiscoveryService service = new AgentDiscoveryService(null, null);
    ...
    void readInstalledPluginExtractsPluginCapabilities(@TempDir Path tempDir) throws Exception {
        Path pluginsRoot = tempDir.resolve("installed-plugins");
        Path pluginRoot = pluginsRoot.resolve("_direct").resolve("demo-plugin");
